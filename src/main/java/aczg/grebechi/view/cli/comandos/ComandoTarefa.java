...
public class ComandoTarefa implements Comando {
    ...
    public String getTutorial() {
        return ConsoleUtil.NEGRITO + ConsoleUtil.CIANO + "\nTUTORIAL: Comando Tarefa\n" + ConsoleUtil.RESET +
                ...
                ConsoleUtil.NEGRITO + "Listagem (Flags de ordenação):\n" + ConsoleUtil.RESET +
                ...
                "  " + ConsoleUtil.VERDE + "listar -d" + ConsoleUtil.RESET + "        : Lista ordenando por Data de Entrega.\n" +
    ...
    private void listarTarefas(Quadro quadro, String[] argumentos) {
        ...
        switch (flag) {
            case "-c":
                ...
                break;
            case "-d":
                tarefas.sort(Comparator.comparing(Tarefa::getDataTermino));
                System.out.println(ConsoleUtil.NEGRITO + "\n=== Tarefas ordenadas por DATA DE ENTREGA ===" + ConsoleUtil.RESET);
                break;
            case "-s":
        ...
        for (Tarefa t : tarefas) {
            if (t.getPrioridade() == 1) {
                ...
                // Imprime normalmente para prioridades maiores que 1
    ...
    private void editarTarefa(Quadro quadro, String[] argumentos) {
        ...
        while (editando) {
            ...
            System.out.println("3. Data Término: " + tarefa.getDataTermino());
            ...
            switch (opcao) {
                ...
                case "3":
                    ...
                    try {
                        tarefa.setDataTermino(LocalDate.parse(scanner.nextLine().trim()));
                    } catch (DateTimeParseException e) {
                        System.out.println(ConsoleUtil.AMARELO + "Data inválida!" + ConsoleUtil.RESET);
                    }
                    break;
                case "4":
